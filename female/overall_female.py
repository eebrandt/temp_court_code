...
trialinfo_folder = "/home/eebrandt/projects/temp_trials/female_choice/data/"
...
timedata_folder = "/home/eebrandt/projects/temp_trials/female_choice/data/"
...
while fileint < len(tsvs):
	...
	timesread = pd.read_csv(trial_folder +"/"+ tsvs[fileint],sep='\t', skiprows = 24, header = 1, dtype={'time': float, 'subject': str, 'behavior': str, 'modifier': str, 'comment': str, 'stauts': str})
